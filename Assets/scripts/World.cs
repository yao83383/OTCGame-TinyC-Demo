...
public class World : MonoBehaviour
{
	...
	public int speed;
	[HideInInspector]
	public List<Block> freeBlocks = new List<Block>();
	[HideInInspector]
	public Block[,] blockCells = new Block[10, 10];
	[HideInInspector]
	...
	[HideInInspector]
	public List<Block> combiningBlocks = new List<Block>();
	[HideInInspector]
	...
	[HideInInspector]
	public List<Block> wars = new List<Block>();
	[HideInInspector]
